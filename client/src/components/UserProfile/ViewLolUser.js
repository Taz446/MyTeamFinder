...
class ViewLolUser extends React.Component {
    state = {user: null}
    ...
    init = async () => {
        const response = await mtf.get(`/lol-users/${this.props.userId}/user`)
...
export default connect(mapStateToProps, {fetchUser, fetchGames})(ViewLolUser);